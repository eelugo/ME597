...
USER = 'evinlugoquinones' # MySQL account name
PASSWORD = 'GoldRush1!' # Password of the account
DB = 'ME597Spring24' # DB name
TABLE = 'evinlugoquinones_lab6' # table name
## Credentials

## MTConnect info.
agent = "192.168.1.30" #IP Address of RPI
agent_port = "5001"
