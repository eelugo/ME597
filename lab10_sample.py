...
CHUNK = int(2048) # chunk size (ro Count/sequence)
IP = '192.168.1.4'
PORT = '5001'
AGENT = f"http://{IP}:{PORT}/" # MTConnect agent ip:port

N = int(SAMP_RATE / CHUNK) # number of sequence to take sound
...
print(f"Length of signal is {len(signal) / SAMP_RATE} [sec]") # signal length is second unit
